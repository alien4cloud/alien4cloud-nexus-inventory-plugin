...
module.exports = webpackMerge.strategy(mergeStrategy)(commonConfig({ env: ENV }), {
    ...
    entry: {
        polyfills: './projects/alien4cloud-nexus-inventory-export-ui/src/app/polyfills',
        global: './projects/alien4cloud-nexus-inventory-export-ui/assets/styles/main.scss',
        main: './projects/alien4cloud-nexus-inventory-export-ui/src/app/main'
    },
    output: {
    ...
    plugins: [
        ...
        new AngularCompilerPlugin({
            mainPath: utils.root('projects/alien4cloud-nexus-inventory-export-ui/src/app/main.ts'),
